...
%  preset delay period. Calcium and synaptic material dynamics are both 
%  implemented using eulers integration. Transmission delays are currently
%  assumed to be a single time step (1ms) for simplicity however this could
