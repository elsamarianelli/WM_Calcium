...
[p, in] = get_params(1, ...     % to multiply number of neurones by
                    ...
                    1.022,...    % reactivating signal contrast factor
...
M = M_new;
% % 
plot(500:500:9000, fire_rate_means); hold on;

plot(500:500:9000, fire_rate_mean_others_all)
