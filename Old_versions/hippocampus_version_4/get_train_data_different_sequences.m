function[shuffled_spikes_x_trials,sequenceID] = get_train_data_different_sequences(C, J, n_trials, p, ca3_ensembles, time_1, time_2)
...
odour_sequences     = {'AA', 'BB', 'CC'};
reward_outcome      = [0 0 0];
