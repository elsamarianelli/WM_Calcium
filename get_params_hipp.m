function p = get_params_hipp(factor)
    ...
    p.c       = 1;                          % Probability of synaptic contact
    ...
    p.tau_e   = 17;                           % membrane time constant
    ...
    p.tau_decay = 400;                        %recovery of synaptic resources 
    ...
    p.CF = 1.4;                              % stimulation contrast factor
