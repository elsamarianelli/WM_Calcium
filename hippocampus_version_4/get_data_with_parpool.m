...
main_folder = 'FixIn_true_delay_2000_CA3overlap_0.2_trials_100_1st_100_secs_CF_varied_more';
...
cmap = spring(64); 
cf_performance = plot_performance_across_variable_change(scaleF_list, main_folder, cmap, 'contrast factor');
